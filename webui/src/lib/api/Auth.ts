...
/**
 * POST /api/v0/auth/login — verifies credentials and sets the session cookie.
...
/**
 * POST /api/v0/auth/logout — clears the session cookie; when the SPA's spa
...
/**
 * PUT /api/v0/auth/password — changes the signed-in user's own password after
